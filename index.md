...
<section class="scene scene--about" aria-label="About">
...
<section class="scene scene--career" aria-label="Career">
...
<section class="scene scene--research" aria-label="Research Interests">
...
<section class="scene scene--news" aria-label="News">
...
<section class="scene scene--publications" aria-label="Publications">

{% include_relative _includes/publications.md %}

</section>

<section class="scene scene--awards" aria-label="Competition and Awards">
...
<section class="scene scene--services" aria-label="Services">
